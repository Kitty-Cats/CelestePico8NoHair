...
namespace Celeste.Mod.Pico8NoHair.Pico
{
    public class DrawHair
    {
        ...
        private static void OnDrawHair(On.Celeste.Pico8.Classic.player_hair.orig_draw_hair orig, Pico8.Classic.player_hair self,Pico8.Classic.ClassicObject obj, int facing, int djump)
        {
